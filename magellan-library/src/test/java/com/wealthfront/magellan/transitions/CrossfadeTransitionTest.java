...
public class CrossfadeTransitionTest {
  ...
  private void checkAnimate(Transition navType, Direction direction) {
    new CrossfadeTransition().animate(from, to, navType, direction, new com.wealthfront.magellan.transitions.Transition.Callback() {
      @Override
