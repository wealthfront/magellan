...
class DisableAnimationsAndKeyboardRule : TestRule {
  ...
  private fun enableAnimationsAndKeyboard() {
    Log.v(DisableAnimationsAndKeyboardRule::class.java.simpleName, "Enabling animations and keyboard")
  ...
  private fun disableAnimationsAndKeyboard() {
    Log.v(DisableAnimationsAndKeyboardRule::class.java.simpleName, "Disabling animations and keyboard")
